...
public class FactoryDoor extends SuperSmoothMover
{
    ...
    public FactoryDoor() {
        // Load frames
        doorFrames = new GreenfootImage[8];
        for (int i = 0; i < 8; i++) {
            doorFrames[i] = new GreenfootImage("factorydoor00" + (i+1) + ".png");
            doorFrames[i].scale(60,60);
        }
